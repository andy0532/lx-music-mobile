...
ctjs = ctjs.substring(0, lastBracket) + allGlassThemes + '\n' + ctjs.substring(lastBracket);
fs.writeFileSync(path.join(BASE, 'src/theme/themes/createThemes.js'), ctjs);
console.log('   createThemes.js updated with 6 glass themes');
