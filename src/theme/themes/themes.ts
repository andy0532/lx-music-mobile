...
export default [
  ...
  },
  {
    ...
    "config": {
      ...
      "extInfo": {
        "c-app-background": "rgba(0, 0, 0, 0)",
        "c-main-background": "rgba(5, 15, 40, 0.05)",
        ...
        "c-content-background": "rgba(5, 15, 40, 0.08)",
        "c-border-background": "rgba(60, 140, 220, 0.50)"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "config": {
      "themeColors": {
        "c-primary": "rgb(30, 90, 170)",
        "c-primary-dark-100": "rgb(27,81,153)",
        "c-primary-dark-100-alpha-100": "rgba(27, 81, 153, 0.90)",
        "c-primary-alpha-100": "rgba(30, 90, 170, 0.90)",
        "c-primary-dark-100-alpha-200": "rgba(27, 81, 153, 0.80)",
        "c-primary-alpha-200": "rgba(30, 90, 170, 0.80)",
        "c-primary-dark-100-alpha-300": "rgba(27, 81, 153, 0.70)",
        "c-primary-alpha-300": "rgba(30, 90, 170, 0.70)",
        "c-primary-dark-100-alpha-400": "rgba(27, 81, 153, 0.60)",
        "c-primary-alpha-400": "rgba(30, 90, 170, 0.60)",
        "c-primary-dark-100-alpha-500": "rgba(27, 81, 153, 0.50)",
        "c-primary-alpha-500": "rgba(30, 90, 170, 0.50)",
        "c-primary-dark-100-alpha-600": "rgba(27, 81, 153, 0.40)",
        "c-primary-alpha-600": "rgba(30, 90, 170, 0.40)",
        "c-primary-dark-100-alpha-700": "rgba(27, 81, 153, 0.30)",
        "c-primary-alpha-700": "rgba(30, 90, 170, 0.30)",
        "c-primary-dark-100-alpha-800": "rgba(27, 81, 153, 0.20)",
        "c-primary-alpha-800": "rgba(30, 90, 170, 0.20)",
        "c-primary-dark-100-alpha-900": "rgba(27, 81, 153, 0.10)",
        "c-primary-alpha-900": "rgba(30, 90, 170, 0.10)",
        "c-primary-dark-200": "rgb(24,73,138)",
        "c-primary-dark-200-alpha-100": "rgba(24, 73, 138, 0.90)",
        "c-primary-dark-200-alpha-200": "rgba(24, 73, 138, 0.80)",
        "c-primary-dark-200-alpha-300": "rgba(24, 73, 138, 0.70)",
        "c-primary-dark-200-alpha-400": "rgba(24, 73, 138, 0.60)",
        "c-primary-dark-200-alpha-500": "rgba(24, 73, 138, 0.50)",
        "c-primary-dark-200-alpha-600": "rgba(24, 73, 138, 0.40)",
        "c-primary-dark-200-alpha-700": "rgba(24, 73, 138, 0.30)",
        "c-primary-dark-200-alpha-800": "rgba(24, 73, 138, 0.20)",
        "c-primary-dark-200-alpha-900": "rgba(24, 73, 138, 0.10)",
        "c-primary-dark-300": "rgb(22,66,124)",
        "c-primary-dark-300-alpha-100": "rgba(22, 66, 124, 0.90)",
        "c-primary-dark-300-alpha-200": "rgba(22, 66, 124, 0.80)",
        "c-primary-dark-300-alpha-300": "rgba(22, 66, 124, 0.70)",
        "c-primary-dark-300-alpha-400": "rgba(22, 66, 124, 0.60)",
        "c-primary-dark-300-alpha-500": "rgba(22, 66, 124, 0.50)",
        "c-primary-dark-300-alpha-600": "rgba(22, 66, 124, 0.40)",
        "c-primary-dark-300-alpha-700": "rgba(22, 66, 124, 0.30)",
        "c-primary-dark-300-alpha-800": "rgba(22, 66, 124, 0.20)",
        "c-primary-dark-300-alpha-900": "rgba(22, 66, 124, 0.10)",
        "c-primary-dark-400": "rgb(20,59,112)",
        "c-primary-dark-400-alpha-100": "rgba(20, 59, 112, 0.90)",
        "c-primary-dark-400-alpha-200": "rgba(20, 59, 112, 0.80)",
        "c-primary-dark-400-alpha-300": "rgba(20, 59, 112, 0.70)",
        "c-primary-dark-400-alpha-400": "rgba(20, 59, 112, 0.60)",
        "c-primary-dark-400-alpha-500": "rgba(20, 59, 112, 0.50)",
        "c-primary-dark-400-alpha-600": "rgba(20, 59, 112, 0.40)",
        "c-primary-dark-400-alpha-700": "rgba(20, 59, 112, 0.30)",
        "c-primary-dark-400-alpha-800": "rgba(20, 59, 112, 0.20)",
        "c-primary-dark-400-alpha-900": "rgba(20, 59, 112, 0.10)",
        "c-primary-dark-500": "rgb(18,53,101)",
        "c-primary-dark-500-alpha-100": "rgba(18, 53, 101, 0.90)",
        "c-primary-dark-500-alpha-200": "rgba(18, 53, 101, 0.80)",
        "c-primary-dark-500-alpha-300": "rgba(18, 53, 101, 0.70)",
        "c-primary-dark-500-alpha-400": "rgba(18, 53, 101, 0.60)",
        "c-primary-dark-500-alpha-500": "rgba(18, 53, 101, 0.50)",
        "c-primary-dark-500-alpha-600": "rgba(18, 53, 101, 0.40)",
        "c-primary-dark-500-alpha-700": "rgba(18, 53, 101, 0.30)",
        "c-primary-dark-500-alpha-800": "rgba(18, 53, 101, 0.20)",
        "c-primary-dark-500-alpha-900": "rgba(18, 53, 101, 0.10)",
        "c-primary-dark-600": "rgb(16,48,91)",
        "c-primary-dark-600-alpha-100": "rgba(16, 48, 91, 0.90)",
        "c-primary-dark-600-alpha-200": "rgba(16, 48, 91, 0.80)",
        "c-primary-dark-600-alpha-300": "rgba(16, 48, 91, 0.70)",
        "c-primary-dark-600-alpha-400": "rgba(16, 48, 91, 0.60)",
        "c-primary-dark-600-alpha-500": "rgba(16, 48, 91, 0.50)",
        "c-primary-dark-600-alpha-600": "rgba(16, 48, 91, 0.40)",
        "c-primary-dark-600-alpha-700": "rgba(16, 48, 91, 0.30)",
        "c-primary-dark-600-alpha-800": "rgba(16, 48, 91, 0.20)",
        "c-primary-dark-600-alpha-900": "rgba(16, 48, 91, 0.10)",
        "c-primary-dark-700": "rgb(14,43,82)",
        "c-primary-dark-700-alpha-100": "rgba(14, 43, 82, 0.90)",
        "c-primary-dark-700-alpha-200": "rgba(14, 43, 82, 0.80)",
        "c-primary-dark-700-alpha-300": "rgba(14, 43, 82, 0.70)",
        "c-primary-dark-700-alpha-400": "rgba(14, 43, 82, 0.60)",
        "c-primary-dark-700-alpha-500": "rgba(14, 43, 82, 0.50)",
        "c-primary-dark-700-alpha-600": "rgba(14, 43, 82, 0.40)",
        "c-primary-dark-700-alpha-700": "rgba(14, 43, 82, 0.30)",
        "c-primary-dark-700-alpha-800": "rgba(14, 43, 82, 0.20)",
        "c-primary-dark-700-alpha-900": "rgba(14, 43, 82, 0.10)",
        "c-primary-dark-800": "rgb(13,39,74)",
        "c-primary-dark-800-alpha-100": "rgba(13, 39, 74, 0.90)",
        "c-primary-dark-800-alpha-200": "rgba(13, 39, 74, 0.80)",
        "c-primary-dark-800-alpha-300": "rgba(13, 39, 74, 0.70)",
        "c-primary-dark-800-alpha-400": "rgba(13, 39, 74, 0.60)",
        "c-primary-dark-800-alpha-500": "rgba(13, 39, 74, 0.50)",
        "c-primary-dark-800-alpha-600": "rgba(13, 39, 74, 0.40)",
        "c-primary-dark-800-alpha-700": "rgba(13, 39, 74, 0.30)",
        "c-primary-dark-800-alpha-800": "rgba(13, 39, 74, 0.20)",
        "c-primary-dark-800-alpha-900": "rgba(13, 39, 74, 0.10)",
        "c-primary-dark-900": "rgb(12,35,67)",
        "c-primary-dark-900-alpha-100": "rgba(12, 35, 67, 0.90)",
        "c-primary-dark-900-alpha-200": "rgba(12, 35, 67, 0.80)",
        "c-primary-dark-900-alpha-300": "rgba(12, 35, 67, 0.70)",
        "c-primary-dark-900-alpha-400": "rgba(12, 35, 67, 0.60)",
        "c-primary-dark-900-alpha-500": "rgba(12, 35, 67, 0.50)",
        "c-primary-dark-900-alpha-600": "rgba(12, 35, 67, 0.40)",
        "c-primary-dark-900-alpha-700": "rgba(12, 35, 67, 0.30)",
        "c-primary-dark-900-alpha-800": "rgba(12, 35, 67, 0.20)",
        "c-primary-dark-900-alpha-900": "rgba(12, 35, 67, 0.10)",
        "c-primary-dark-1000": "rgb(11,32,60)",
        "c-primary-dark-1000-alpha-100": "rgba(11, 32, 60, 0.90)",
        "c-primary-dark-1000-alpha-200": "rgba(11, 32, 60, 0.80)",
        "c-primary-dark-1000-alpha-300": "rgba(11, 32, 60, 0.70)",
        "c-primary-dark-1000-alpha-400": "rgba(11, 32, 60, 0.60)",
        "c-primary-dark-1000-alpha-500": "rgba(11, 32, 60, 0.50)",
        "c-primary-dark-1000-alpha-600": "rgba(11, 32, 60, 0.40)",
        "c-primary-dark-1000-alpha-700": "rgba(11, 32, 60, 0.30)",
        "c-primary-dark-1000-alpha-800": "rgba(11, 32, 60, 0.20)",
        "c-primary-dark-1000-alpha-900": "rgba(11, 32, 60, 0.10)",
        "c-primary-light-100": "rgb(75,123,187)",
        "c-primary-light-100-alpha-100": "rgba(75, 123, 187, 0.90)",
        "c-primary-light-100-alpha-200": "rgba(75, 123, 187, 0.80)",
        "c-primary-light-100-alpha-300": "rgba(75, 123, 187, 0.70)",
        "c-primary-light-100-alpha-400": "rgba(75, 123, 187, 0.60)",
        "c-primary-light-100-alpha-500": "rgba(75, 123, 187, 0.50)",
        "c-primary-light-100-alpha-600": "rgba(75, 123, 187, 0.40)",
        "c-primary-light-100-alpha-700": "rgba(75, 123, 187, 0.30)",
        "c-primary-light-100-alpha-800": "rgba(75, 123, 187, 0.20)",
        "c-primary-light-100-alpha-900": "rgba(75, 123, 187, 0.10)",
        "c-primary-light-200": "rgb(111,149,201)",
        "c-primary-light-200-alpha-100": "rgba(111, 149, 201, 0.90)",
        "c-primary-light-200-alpha-200": "rgba(111, 149, 201, 0.80)",
        "c-primary-light-200-alpha-300": "rgba(111, 149, 201, 0.70)",
        "c-primary-light-200-alpha-400": "rgba(111, 149, 201, 0.60)",
        "c-primary-light-200-alpha-500": "rgba(111, 149, 201, 0.50)",
        "c-primary-light-200-alpha-600": "rgba(111, 149, 201, 0.40)",
        "c-primary-light-200-alpha-700": "rgba(111, 149, 201, 0.30)",
        "c-primary-light-200-alpha-800": "rgba(111, 149, 201, 0.20)",
        "c-primary-light-200-alpha-900": "rgba(111, 149, 201, 0.10)",
        "c-primary-light-300": "rgb(140,170,212)",
        "c-primary-light-300-alpha-100": "rgba(140, 170, 212, 0.90)",
        "c-primary-light-300-alpha-200": "rgba(140, 170, 212, 0.80)",
        "c-primary-light-300-alpha-300": "rgba(140, 170, 212, 0.70)",
        "c-primary-light-300-alpha-400": "rgba(140, 170, 212, 0.60)",
        "c-primary-light-300-alpha-500": "rgba(140, 170, 212, 0.50)",
        "c-primary-light-300-alpha-600": "rgba(140, 170, 212, 0.40)",
        "c-primary-light-300-alpha-700": "rgba(140, 170, 212, 0.30)",
        "c-primary-light-300-alpha-800": "rgba(140, 170, 212, 0.20)",
        "c-primary-light-300-alpha-900": "rgba(140, 170, 212, 0.10)",
        "c-primary-light-400": "rgb(163,187,221)",
        "c-primary-light-400-alpha-100": "rgba(163, 187, 221, 0.90)",
        "c-primary-light-400-alpha-200": "rgba(163, 187, 221, 0.80)",
        "c-primary-light-400-alpha-300": "rgba(163, 187, 221, 0.70)",
        "c-primary-light-400-alpha-400": "rgba(163, 187, 221, 0.60)",
        "c-primary-light-400-alpha-500": "rgba(163, 187, 221, 0.50)",
        "c-primary-light-400-alpha-600": "rgba(163, 187, 221, 0.40)",
        "c-primary-light-400-alpha-700": "rgba(163, 187, 221, 0.30)",
        "c-primary-light-400-alpha-800": "rgba(163, 187, 221, 0.20)",
        "c-primary-light-400-alpha-900": "rgba(163, 187, 221, 0.10)",
        "c-primary-light-500": "rgb(181,201,228)",
        "c-primary-light-500-alpha-100": "rgba(181, 201, 228, 0.90)",
        "c-primary-light-500-alpha-200": "rgba(181, 201, 228, 0.80)",
        "c-primary-light-500-alpha-300": "rgba(181, 201, 228, 0.70)",
        "c-primary-light-500-alpha-400": "rgba(181, 201, 228, 0.60)",
        "c-primary-light-500-alpha-500": "rgba(181, 201, 228, 0.50)",
        "c-primary-light-500-alpha-600": "rgba(181, 201, 228, 0.40)",
        "c-primary-light-500-alpha-700": "rgba(181, 201, 228, 0.30)",
        "c-primary-light-500-alpha-800": "rgba(181, 201, 228, 0.20)",
        "c-primary-light-500-alpha-900": "rgba(181, 201, 228, 0.10)",
        "c-primary-light-600": "rgb(196,212,233)",
        "c-primary-light-600-alpha-100": "rgba(196, 212, 233, 0.90)",
        "c-primary-light-600-alpha-200": "rgba(196, 212, 233, 0.80)",
        "c-primary-light-600-alpha-300": "rgba(196, 212, 233, 0.70)",
        "c-primary-light-600-alpha-400": "rgba(196, 212, 233, 0.60)",
        "c-primary-light-600-alpha-500": "rgba(196, 212, 233, 0.50)",
        "c-primary-light-600-alpha-600": "rgba(196, 212, 233, 0.40)",
        "c-primary-light-600-alpha-700": "rgba(196, 212, 233, 0.30)",
        "c-primary-light-600-alpha-800": "rgba(196, 212, 233, 0.20)",
        "c-primary-light-600-alpha-900": "rgba(196, 212, 233, 0.10)",
        "c-primary-light-700": "rgb(208,221,237)",
        "c-primary-light-700-alpha-100": "rgba(208, 221, 237, 0.90)",
        "c-primary-light-700-alpha-200": "rgba(208, 221, 237, 0.80)",
        "c-primary-light-700-alpha-300": "rgba(208, 221, 237, 0.70)",
        "c-primary-light-700-alpha-400": "rgba(208, 221, 237, 0.60)",
        "c-primary-light-700-alpha-500": "rgba(208, 221, 237, 0.50)",
        "c-primary-light-700-alpha-600": "rgba(208, 221, 237, 0.40)",
        "c-primary-light-700-alpha-700": "rgba(208, 221, 237, 0.30)",
        "c-primary-light-700-alpha-800": "rgba(208, 221, 237, 0.20)",
        "c-primary-light-700-alpha-900": "rgba(208, 221, 237, 0.10)",
        "c-primary-light-800": "rgb(217,228,241)",
        "c-primary-light-800-alpha-100": "rgba(217, 228, 241, 0.90)",
        "c-primary-light-800-alpha-200": "rgba(217, 228, 241, 0.80)",
        "c-primary-light-800-alpha-300": "rgba(217, 228, 241, 0.70)",
        "c-primary-light-800-alpha-400": "rgba(217, 228, 241, 0.60)",
        "c-primary-light-800-alpha-500": "rgba(217, 228, 241, 0.50)",
        "c-primary-light-800-alpha-600": "rgba(217, 228, 241, 0.40)",
        "c-primary-light-800-alpha-700": "rgba(217, 228, 241, 0.30)",
        "c-primary-light-800-alpha-800": "rgba(217, 228, 241, 0.20)",
        "c-primary-light-800-alpha-900": "rgba(217, 228, 241, 0.10)",
        "c-primary-light-900": "rgb(225,233,244)",
        "c-primary-light-900-alpha-100": "rgba(225, 233, 244, 0.90)",
        "c-primary-light-900-alpha-200": "rgba(225, 233, 244, 0.80)",
        "c-primary-light-900-alpha-300": "rgba(225, 233, 244, 0.70)",
        "c-primary-light-900-alpha-400": "rgba(225, 233, 244, 0.60)",
        "c-primary-light-900-alpha-500": "rgba(225, 233, 244, 0.50)",
        "c-primary-light-900-alpha-600": "rgba(225, 233, 244, 0.40)",
        "c-primary-light-900-alpha-700": "rgba(225, 233, 244, 0.30)",
        "c-primary-light-900-alpha-800": "rgba(225, 233, 244, 0.20)",
        "c-primary-light-900-alpha-900": "rgba(225, 233, 244, 0.10)",
        "c-primary-light-1000": "rgb(255,255,255)",
        "c-primary-light-1000-alpha-100": "rgba(255, 255, 255, 0.90)",
        "c-primary-light-1000-alpha-200": "rgba(255, 255, 255, 0.80)",
        "c-primary-light-1000-alpha-300": "rgba(255, 255, 255, 0.70)",
      ...
      "extInfo": {
        "c-app-background": "rgba(0, 0, 0, 0)",
        "c-main-background": "rgba(255, 255, 255, 0.22)",
        ...
        "c-content-background": "rgba(255, 255, 255, 0.15)",
        "c-border-background": "rgba(80, 140, 220, 0.40)"
      }
    }
  },
  {
    ...
    "config": {
      "themeColors": {
        "c-primary": "rgb(190, 50, 90)",
        "c-primary-dark-100": "rgb(171,45,81)",
        "c-primary-dark-100-alpha-100": "rgba(171, 45, 81, 0.90)",
        "c-primary-alpha-100": "rgba(190, 50, 90, 0.90)",
        "c-primary-dark-100-alpha-200": "rgba(171, 45, 81, 0.80)",
        "c-primary-alpha-200": "rgba(190, 50, 90, 0.80)",
        "c-primary-dark-100-alpha-300": "rgba(171, 45, 81, 0.70)",
        "c-primary-alpha-300": "rgba(190, 50, 90, 0.70)",
        "c-primary-dark-100-alpha-400": "rgba(171, 45, 81, 0.60)",
        "c-primary-alpha-400": "rgba(190, 50, 90, 0.60)",
        "c-primary-dark-100-alpha-500": "rgba(171, 45, 81, 0.50)",
        "c-primary-alpha-500": "rgba(190, 50, 90, 0.50)",
        "c-primary-dark-100-alpha-600": "rgba(171, 45, 81, 0.40)",
        "c-primary-alpha-600": "rgba(190, 50, 90, 0.40)",
        "c-primary-dark-100-alpha-700": "rgba(171, 45, 81, 0.30)",
        "c-primary-alpha-700": "rgba(190, 50, 90, 0.30)",
        "c-primary-dark-100-alpha-800": "rgba(171, 45, 81, 0.20)",
        "c-primary-alpha-800": "rgba(190, 50, 90, 0.20)",
        "c-primary-dark-100-alpha-900": "rgba(171, 45, 81, 0.10)",
        "c-primary-alpha-900": "rgba(190, 50, 90, 0.10)",
        "c-primary-dark-200": "rgb(154,41,73)",
        "c-primary-dark-200-alpha-100": "rgba(154, 41, 73, 0.90)",
        "c-primary-dark-200-alpha-200": "rgba(154, 41, 73, 0.80)",
        "c-primary-dark-200-alpha-300": "rgba(154, 41, 73, 0.70)",
        "c-primary-dark-200-alpha-400": "rgba(154, 41, 73, 0.60)",
        "c-primary-dark-200-alpha-500": "rgba(154, 41, 73, 0.50)",
        "c-primary-dark-200-alpha-600": "rgba(154, 41, 73, 0.40)",
        "c-primary-dark-200-alpha-700": "rgba(154, 41, 73, 0.30)",
        "c-primary-dark-200-alpha-800": "rgba(154, 41, 73, 0.20)",
        "c-primary-dark-200-alpha-900": "rgba(154, 41, 73, 0.10)",
        "c-primary-dark-300": "rgb(139,37,66)",
        "c-primary-dark-300-alpha-100": "rgba(139, 37, 66, 0.90)",
        "c-primary-dark-300-alpha-200": "rgba(139, 37, 66, 0.80)",
        "c-primary-dark-300-alpha-300": "rgba(139, 37, 66, 0.70)",
        "c-primary-dark-300-alpha-400": "rgba(139, 37, 66, 0.60)",
        "c-primary-dark-300-alpha-500": "rgba(139, 37, 66, 0.50)",
        "c-primary-dark-300-alpha-600": "rgba(139, 37, 66, 0.40)",
        "c-primary-dark-300-alpha-700": "rgba(139, 37, 66, 0.30)",
        "c-primary-dark-300-alpha-800": "rgba(139, 37, 66, 0.20)",
        "c-primary-dark-300-alpha-900": "rgba(139, 37, 66, 0.10)",
        "c-primary-dark-400": "rgb(125,33,59)",
        "c-primary-dark-400-alpha-100": "rgba(125, 33, 59, 0.90)",
        "c-primary-dark-400-alpha-200": "rgba(125, 33, 59, 0.80)",
        "c-primary-dark-400-alpha-300": "rgba(125, 33, 59, 0.70)",
        "c-primary-dark-400-alpha-400": "rgba(125, 33, 59, 0.60)",
        "c-primary-dark-400-alpha-500": "rgba(125, 33, 59, 0.50)",
        "c-primary-dark-400-alpha-600": "rgba(125, 33, 59, 0.40)",
        "c-primary-dark-400-alpha-700": "rgba(125, 33, 59, 0.30)",
        "c-primary-dark-400-alpha-800": "rgba(125, 33, 59, 0.20)",
        "c-primary-dark-400-alpha-900": "rgba(125, 33, 59, 0.10)",
        "c-primary-dark-500": "rgb(113,30,53)",
        "c-primary-dark-500-alpha-100": "rgba(113, 30, 53, 0.90)",
        "c-primary-dark-500-alpha-200": "rgba(113, 30, 53, 0.80)",
        "c-primary-dark-500-alpha-300": "rgba(113, 30, 53, 0.70)",
        "c-primary-dark-500-alpha-400": "rgba(113, 30, 53, 0.60)",
        "c-primary-dark-500-alpha-500": "rgba(113, 30, 53, 0.50)",
        "c-primary-dark-500-alpha-600": "rgba(113, 30, 53, 0.40)",
        "c-primary-dark-500-alpha-700": "rgba(113, 30, 53, 0.30)",
        "c-primary-dark-500-alpha-800": "rgba(113, 30, 53, 0.20)",
        "c-primary-dark-500-alpha-900": "rgba(113, 30, 53, 0.10)",
        "c-primary-dark-600": "rgb(102,27,48)",
        "c-primary-dark-600-alpha-100": "rgba(102, 27, 48, 0.90)",
        "c-primary-dark-600-alpha-200": "rgba(102, 27, 48, 0.80)",
        "c-primary-dark-600-alpha-300": "rgba(102, 27, 48, 0.70)",
        "c-primary-dark-600-alpha-400": "rgba(102, 27, 48, 0.60)",
        "c-primary-dark-600-alpha-500": "rgba(102, 27, 48, 0.50)",
        "c-primary-dark-600-alpha-600": "rgba(102, 27, 48, 0.40)",
        "c-primary-dark-600-alpha-700": "rgba(102, 27, 48, 0.30)",
        "c-primary-dark-600-alpha-800": "rgba(102, 27, 48, 0.20)",
        "c-primary-dark-600-alpha-900": "rgba(102, 27, 48, 0.10)",
        "c-primary-dark-700": "rgb(92,24,43)",
        "c-primary-dark-700-alpha-100": "rgba(92, 24, 43, 0.90)",
        "c-primary-dark-700-alpha-200": "rgba(92, 24, 43, 0.80)",
        "c-primary-dark-700-alpha-300": "rgba(92, 24, 43, 0.70)",
        "c-primary-dark-700-alpha-400": "rgba(92, 24, 43, 0.60)",
        "c-primary-dark-700-alpha-500": "rgba(92, 24, 43, 0.50)",
        "c-primary-dark-700-alpha-600": "rgba(92, 24, 43, 0.40)",
        "c-primary-dark-700-alpha-700": "rgba(92, 24, 43, 0.30)",
        "c-primary-dark-700-alpha-800": "rgba(92, 24, 43, 0.20)",
        "c-primary-dark-700-alpha-900": "rgba(92, 24, 43, 0.10)",
        "c-primary-dark-800": "rgb(83,22,39)",
        "c-primary-dark-800-alpha-100": "rgba(83, 22, 39, 0.90)",
        "c-primary-dark-800-alpha-200": "rgba(83, 22, 39, 0.80)",
        "c-primary-dark-800-alpha-300": "rgba(83, 22, 39, 0.70)",
        "c-primary-dark-800-alpha-400": "rgba(83, 22, 39, 0.60)",
        "c-primary-dark-800-alpha-500": "rgba(83, 22, 39, 0.50)",
        "c-primary-dark-800-alpha-600": "rgba(83, 22, 39, 0.40)",
        "c-primary-dark-800-alpha-700": "rgba(83, 22, 39, 0.30)",
        "c-primary-dark-800-alpha-800": "rgba(83, 22, 39, 0.20)",
        "c-primary-dark-800-alpha-900": "rgba(83, 22, 39, 0.10)",
        "c-primary-dark-900": "rgb(75,20,35)",
        "c-primary-dark-900-alpha-100": "rgba(75, 20, 35, 0.90)",
        "c-primary-dark-900-alpha-200": "rgba(75, 20, 35, 0.80)",
        "c-primary-dark-900-alpha-300": "rgba(75, 20, 35, 0.70)",
        "c-primary-dark-900-alpha-400": "rgba(75, 20, 35, 0.60)",
        "c-primary-dark-900-alpha-500": "rgba(75, 20, 35, 0.50)",
        "c-primary-dark-900-alpha-600": "rgba(75, 20, 35, 0.40)",
        "c-primary-dark-900-alpha-700": "rgba(75, 20, 35, 0.30)",
        "c-primary-dark-900-alpha-800": "rgba(75, 20, 35, 0.20)",
        "c-primary-dark-900-alpha-900": "rgba(75, 20, 35, 0.10)",
        "c-primary-dark-1000": "rgb(68,18,32)",
        "c-primary-dark-1000-alpha-100": "rgba(68, 18, 32, 0.90)",
        "c-primary-dark-1000-alpha-200": "rgba(68, 18, 32, 0.80)",
        "c-primary-dark-1000-alpha-300": "rgba(68, 18, 32, 0.70)",
        "c-primary-dark-1000-alpha-400": "rgba(68, 18, 32, 0.60)",
        "c-primary-dark-1000-alpha-500": "rgba(68, 18, 32, 0.50)",
        "c-primary-dark-1000-alpha-600": "rgba(68, 18, 32, 0.40)",
        "c-primary-dark-1000-alpha-700": "rgba(68, 18, 32, 0.30)",
        "c-primary-dark-1000-alpha-800": "rgba(68, 18, 32, 0.20)",
        "c-primary-dark-1000-alpha-900": "rgba(68, 18, 32, 0.10)",
        "c-primary-light-100": "rgb(203,91,123)",
        "c-primary-light-100-alpha-100": "rgba(203, 91, 123, 0.90)",
        "c-primary-light-100-alpha-200": "rgba(203, 91, 123, 0.80)",
        "c-primary-light-100-alpha-300": "rgba(203, 91, 123, 0.70)",
        "c-primary-light-100-alpha-400": "rgba(203, 91, 123, 0.60)",
        "c-primary-light-100-alpha-500": "rgba(203, 91, 123, 0.50)",
        "c-primary-light-100-alpha-600": "rgba(203, 91, 123, 0.40)",
        "c-primary-light-100-alpha-700": "rgba(203, 91, 123, 0.30)",
        "c-primary-light-100-alpha-800": "rgba(203, 91, 123, 0.20)",
        "c-primary-light-100-alpha-900": "rgba(203, 91, 123, 0.10)",
        "c-primary-light-200": "rgb(213,124,149)",
        "c-primary-light-200-alpha-100": "rgba(213, 124, 149, 0.90)",
        "c-primary-light-200-alpha-200": "rgba(213, 124, 149, 0.80)",
        "c-primary-light-200-alpha-300": "rgba(213, 124, 149, 0.70)",
        "c-primary-light-200-alpha-400": "rgba(213, 124, 149, 0.60)",
        "c-primary-light-200-alpha-500": "rgba(213, 124, 149, 0.50)",
        "c-primary-light-200-alpha-600": "rgba(213, 124, 149, 0.40)",
        "c-primary-light-200-alpha-700": "rgba(213, 124, 149, 0.30)",
        "c-primary-light-200-alpha-800": "rgba(213, 124, 149, 0.20)",
        "c-primary-light-200-alpha-900": "rgba(213, 124, 149, 0.10)",
        "c-primary-light-300": "rgb(221,150,170)",
        "c-primary-light-300-alpha-100": "rgba(221, 150, 170, 0.90)",
        "c-primary-light-300-alpha-200": "rgba(221, 150, 170, 0.80)",
        "c-primary-light-300-alpha-300": "rgba(221, 150, 170, 0.70)",
        "c-primary-light-300-alpha-400": "rgba(221, 150, 170, 0.60)",
        "c-primary-light-300-alpha-500": "rgba(221, 150, 170, 0.50)",
        "c-primary-light-300-alpha-600": "rgba(221, 150, 170, 0.40)",
        "c-primary-light-300-alpha-700": "rgba(221, 150, 170, 0.30)",
        "c-primary-light-300-alpha-800": "rgba(221, 150, 170, 0.20)",
        "c-primary-light-300-alpha-900": "rgba(221, 150, 170, 0.10)",
        "c-primary-light-400": "rgb(228,171,187)",
        "c-primary-light-400-alpha-100": "rgba(228, 171, 187, 0.90)",
        "c-primary-light-400-alpha-200": "rgba(228, 171, 187, 0.80)",
        "c-primary-light-400-alpha-300": "rgba(228, 171, 187, 0.70)",
        "c-primary-light-400-alpha-400": "rgba(228, 171, 187, 0.60)",
        "c-primary-light-400-alpha-500": "rgba(228, 171, 187, 0.50)",
        "c-primary-light-400-alpha-600": "rgba(228, 171, 187, 0.40)",
        "c-primary-light-400-alpha-700": "rgba(228, 171, 187, 0.30)",
        "c-primary-light-400-alpha-800": "rgba(228, 171, 187, 0.20)",
        "c-primary-light-400-alpha-900": "rgba(228, 171, 187, 0.10)",
        "c-primary-light-500": "rgb(233,188,201)",
        "c-primary-light-500-alpha-100": "rgba(233, 188, 201, 0.90)",
        "c-primary-light-500-alpha-200": "rgba(233, 188, 201, 0.80)",
        "c-primary-light-500-alpha-300": "rgba(233, 188, 201, 0.70)",
        "c-primary-light-500-alpha-400": "rgba(233, 188, 201, 0.60)",
        "c-primary-light-500-alpha-500": "rgba(233, 188, 201, 0.50)",
        "c-primary-light-500-alpha-600": "rgba(233, 188, 201, 0.40)",
        "c-primary-light-500-alpha-700": "rgba(233, 188, 201, 0.30)",
        "c-primary-light-500-alpha-800": "rgba(233, 188, 201, 0.20)",
        "c-primary-light-500-alpha-900": "rgba(233, 188, 201, 0.10)",
        "c-primary-light-600": "rgb(237,201,212)",
        "c-primary-light-600-alpha-100": "rgba(237, 201, 212, 0.90)",
        "c-primary-light-600-alpha-200": "rgba(237, 201, 212, 0.80)",
        "c-primary-light-600-alpha-300": "rgba(237, 201, 212, 0.70)",
        "c-primary-light-600-alpha-400": "rgba(237, 201, 212, 0.60)",
        "c-primary-light-600-alpha-500": "rgba(237, 201, 212, 0.50)",
        "c-primary-light-600-alpha-600": "rgba(237, 201, 212, 0.40)",
        "c-primary-light-600-alpha-700": "rgba(237, 201, 212, 0.30)",
        "c-primary-light-600-alpha-800": "rgba(237, 201, 212, 0.20)",
        "c-primary-light-600-alpha-900": "rgba(237, 201, 212, 0.10)",
        "c-primary-light-700": "rgb(241,212,221)",
        "c-primary-light-700-alpha-100": "rgba(241, 212, 221, 0.90)",
        "c-primary-light-700-alpha-200": "rgba(241, 212, 221, 0.80)",
        "c-primary-light-700-alpha-300": "rgba(241, 212, 221, 0.70)",
        "c-primary-light-700-alpha-400": "rgba(241, 212, 221, 0.60)",
        "c-primary-light-700-alpha-500": "rgba(241, 212, 221, 0.50)",
        "c-primary-light-700-alpha-600": "rgba(241, 212, 221, 0.40)",
        "c-primary-light-700-alpha-700": "rgba(241, 212, 221, 0.30)",
        "c-primary-light-700-alpha-800": "rgba(241, 212, 221, 0.20)",
        "c-primary-light-700-alpha-900": "rgba(241, 212, 221, 0.10)",
        "c-primary-light-800": "rgb(244,221,228)",
        "c-primary-light-800-alpha-100": "rgba(244, 221, 228, 0.90)",
        "c-primary-light-800-alpha-200": "rgba(244, 221, 228, 0.80)",
        "c-primary-light-800-alpha-300": "rgba(244, 221, 228, 0.70)",
        "c-primary-light-800-alpha-400": "rgba(244, 221, 228, 0.60)",
        "c-primary-light-800-alpha-500": "rgba(244, 221, 228, 0.50)",
        "c-primary-light-800-alpha-600": "rgba(244, 221, 228, 0.40)",
        "c-primary-light-800-alpha-700": "rgba(244, 221, 228, 0.30)",
        "c-primary-light-800-alpha-800": "rgba(244, 221, 228, 0.20)",
        "c-primary-light-800-alpha-900": "rgba(244, 221, 228, 0.10)",
        "c-primary-light-900": "rgb(246,228,233)",
        "c-primary-light-900-alpha-100": "rgba(246, 228, 233, 0.90)",
        "c-primary-light-900-alpha-200": "rgba(246, 228, 233, 0.80)",
        "c-primary-light-900-alpha-300": "rgba(246, 228, 233, 0.70)",
        "c-primary-light-900-alpha-400": "rgba(246, 228, 233, 0.60)",
        "c-primary-light-900-alpha-500": "rgba(246, 228, 233, 0.50)",
        "c-primary-light-900-alpha-600": "rgba(246, 228, 233, 0.40)",
        "c-primary-light-900-alpha-700": "rgba(246, 228, 233, 0.30)",
        "c-primary-light-900-alpha-800": "rgba(246, 228, 233, 0.20)",
        "c-primary-light-900-alpha-900": "rgba(246, 228, 233, 0.10)",
        "c-primary-light-1000": "rgb(255,255,255)",
        "c-primary-light-1000-alpha-100": "rgba(255, 255, 255, 0.90)",
        "c-primary-light-1000-alpha-200": "rgba(255, 255, 255, 0.80)",
        "c-primary-light-1000-alpha-300": "rgba(255, 255, 255, 0.70)",
      ...
      "extInfo": {
        "c-app-background": "rgba(0, 0, 0, 0)",
        "c-main-background": "rgba(255, 235, 240, 0.22)",
        ...
        "c-content-background": "rgba(255, 230, 238, 0.15)",
        "c-border-background": "rgba(220, 100, 140, 0.40)"
      }
    }
  },
  {
    ...
    "config": {
      "themeColors": {
        "c-primary": "rgb(35, 140, 65)",
        "c-primary-dark-100": "rgb(32,126,59)",
        "c-primary-dark-100-alpha-100": "rgba(32, 126, 59, 0.90)",
        "c-primary-alpha-100": "rgba(35, 140, 65, 0.90)",
        "c-primary-dark-100-alpha-200": "rgba(32, 126, 59, 0.80)",
        "c-primary-alpha-200": "rgba(35, 140, 65, 0.80)",
        "c-primary-dark-100-alpha-300": "rgba(32, 126, 59, 0.70)",
        "c-primary-alpha-300": "rgba(35, 140, 65, 0.70)",
        "c-primary-dark-100-alpha-400": "rgba(32, 126, 59, 0.60)",
        "c-primary-alpha-400": "rgba(35, 140, 65, 0.60)",
        "c-primary-dark-100-alpha-500": "rgba(32, 126, 59, 0.50)",
        "c-primary-alpha-500": "rgba(35, 140, 65, 0.50)",
        "c-primary-dark-100-alpha-600": "rgba(32, 126, 59, 0.40)",
        "c-primary-alpha-600": "rgba(35, 140, 65, 0.40)",
        "c-primary-dark-100-alpha-700": "rgba(32, 126, 59, 0.30)",
        "c-primary-alpha-700": "rgba(35, 140, 65, 0.30)",
        "c-primary-dark-100-alpha-800": "rgba(32, 126, 59, 0.20)",
        "c-primary-alpha-800": "rgba(35, 140, 65, 0.20)",
        "c-primary-dark-100-alpha-900": "rgba(32, 126, 59, 0.10)",
        "c-primary-alpha-900": "rgba(35, 140, 65, 0.10)",
        "c-primary-dark-200": "rgb(29,113,53)",
        "c-primary-dark-200-alpha-100": "rgba(29, 113, 53, 0.90)",
        "c-primary-dark-200-alpha-200": "rgba(29, 113, 53, 0.80)",
        "c-primary-dark-200-alpha-300": "rgba(29, 113, 53, 0.70)",
        "c-primary-dark-200-alpha-400": "rgba(29, 113, 53, 0.60)",
        "c-primary-dark-200-alpha-500": "rgba(29, 113, 53, 0.50)",
        "c-primary-dark-200-alpha-600": "rgba(29, 113, 53, 0.40)",
        "c-primary-dark-200-alpha-700": "rgba(29, 113, 53, 0.30)",
        "c-primary-dark-200-alpha-800": "rgba(29, 113, 53, 0.20)",
        "c-primary-dark-200-alpha-900": "rgba(29, 113, 53, 0.10)",
        "c-primary-dark-300": "rgb(26,102,48)",
        "c-primary-dark-300-alpha-100": "rgba(26, 102, 48, 0.90)",
        "c-primary-dark-300-alpha-200": "rgba(26, 102, 48, 0.80)",
        "c-primary-dark-300-alpha-300": "rgba(26, 102, 48, 0.70)",
        "c-primary-dark-300-alpha-400": "rgba(26, 102, 48, 0.60)",
        "c-primary-dark-300-alpha-500": "rgba(26, 102, 48, 0.50)",
        "c-primary-dark-300-alpha-600": "rgba(26, 102, 48, 0.40)",
        "c-primary-dark-300-alpha-700": "rgba(26, 102, 48, 0.30)",
        "c-primary-dark-300-alpha-800": "rgba(26, 102, 48, 0.20)",
        "c-primary-dark-300-alpha-900": "rgba(26, 102, 48, 0.10)",
        "c-primary-dark-400": "rgb(23,92,43)",
        "c-primary-dark-400-alpha-100": "rgba(23, 92, 43, 0.90)",
        "c-primary-dark-400-alpha-200": "rgba(23, 92, 43, 0.80)",
        "c-primary-dark-400-alpha-300": "rgba(23, 92, 43, 0.70)",
        "c-primary-dark-400-alpha-400": "rgba(23, 92, 43, 0.60)",
        "c-primary-dark-400-alpha-500": "rgba(23, 92, 43, 0.50)",
        "c-primary-dark-400-alpha-600": "rgba(23, 92, 43, 0.40)",
        "c-primary-dark-400-alpha-700": "rgba(23, 92, 43, 0.30)",
        "c-primary-dark-400-alpha-800": "rgba(23, 92, 43, 0.20)",
        "c-primary-dark-400-alpha-900": "rgba(23, 92, 43, 0.10)",
        "c-primary-dark-500": "rgb(21,83,39)",
        "c-primary-dark-500-alpha-100": "rgba(21, 83, 39, 0.90)",
        "c-primary-dark-500-alpha-200": "rgba(21, 83, 39, 0.80)",
        "c-primary-dark-500-alpha-300": "rgba(21, 83, 39, 0.70)",
        "c-primary-dark-500-alpha-400": "rgba(21, 83, 39, 0.60)",
        "c-primary-dark-500-alpha-500": "rgba(21, 83, 39, 0.50)",
        "c-primary-dark-500-alpha-600": "rgba(21, 83, 39, 0.40)",
        "c-primary-dark-500-alpha-700": "rgba(21, 83, 39, 0.30)",
        "c-primary-dark-500-alpha-800": "rgba(21, 83, 39, 0.20)",
        "c-primary-dark-500-alpha-900": "rgba(21, 83, 39, 0.10)",
        "c-primary-dark-600": "rgb(19,75,35)",
        "c-primary-dark-600-alpha-100": "rgba(19, 75, 35, 0.90)",
        "c-primary-dark-600-alpha-200": "rgba(19, 75, 35, 0.80)",
        "c-primary-dark-600-alpha-300": "rgba(19, 75, 35, 0.70)",
        "c-primary-dark-600-alpha-400": "rgba(19, 75, 35, 0.60)",
        "c-primary-dark-600-alpha-500": "rgba(19, 75, 35, 0.50)",
        "c-primary-dark-600-alpha-600": "rgba(19, 75, 35, 0.40)",
        "c-primary-dark-600-alpha-700": "rgba(19, 75, 35, 0.30)",
        "c-primary-dark-600-alpha-800": "rgba(19, 75, 35, 0.20)",
        "c-primary-dark-600-alpha-900": "rgba(19, 75, 35, 0.10)",
        "c-primary-dark-700": "rgb(17,68,32)",
        "c-primary-dark-700-alpha-100": "rgba(17, 68, 32, 0.90)",
        "c-primary-dark-700-alpha-200": "rgba(17, 68, 32, 0.80)",
        "c-primary-dark-700-alpha-300": "rgba(17, 68, 32, 0.70)",
        "c-primary-dark-700-alpha-400": "rgba(17, 68, 32, 0.60)",
        "c-primary-dark-700-alpha-500": "rgba(17, 68, 32, 0.50)",
        "c-primary-dark-700-alpha-600": "rgba(17, 68, 32, 0.40)",
        "c-primary-dark-700-alpha-700": "rgba(17, 68, 32, 0.30)",
        "c-primary-dark-700-alpha-800": "rgba(17, 68, 32, 0.20)",
        "c-primary-dark-700-alpha-900": "rgba(17, 68, 32, 0.10)",
        "c-primary-dark-800": "rgb(15,61,29)",
        "c-primary-dark-800-alpha-100": "rgba(15, 61, 29, 0.90)",
        "c-primary-dark-800-alpha-200": "rgba(15, 61, 29, 0.80)",
        "c-primary-dark-800-alpha-300": "rgba(15, 61, 29, 0.70)",
        "c-primary-dark-800-alpha-400": "rgba(15, 61, 29, 0.60)",
        "c-primary-dark-800-alpha-500": "rgba(15, 61, 29, 0.50)",
        "c-primary-dark-800-alpha-600": "rgba(15, 61, 29, 0.40)",
        "c-primary-dark-800-alpha-700": "rgba(15, 61, 29, 0.30)",
        "c-primary-dark-800-alpha-800": "rgba(15, 61, 29, 0.20)",
        "c-primary-dark-800-alpha-900": "rgba(15, 61, 29, 0.10)",
        "c-primary-dark-900": "rgb(14,55,26)",
        "c-primary-dark-900-alpha-100": "rgba(14, 55, 26, 0.90)",
        "c-primary-dark-900-alpha-200": "rgba(14, 55, 26, 0.80)",
        "c-primary-dark-900-alpha-300": "rgba(14, 55, 26, 0.70)",
        "c-primary-dark-900-alpha-400": "rgba(14, 55, 26, 0.60)",
        "c-primary-dark-900-alpha-500": "rgba(14, 55, 26, 0.50)",
        "c-primary-dark-900-alpha-600": "rgba(14, 55, 26, 0.40)",
        "c-primary-dark-900-alpha-700": "rgba(14, 55, 26, 0.30)",
        "c-primary-dark-900-alpha-800": "rgba(14, 55, 26, 0.20)",
        "c-primary-dark-900-alpha-900": "rgba(14, 55, 26, 0.10)",
        "c-primary-dark-1000": "rgb(13,50,23)",
        "c-primary-dark-1000-alpha-100": "rgba(13, 50, 23, 0.90)",
        "c-primary-dark-1000-alpha-200": "rgba(13, 50, 23, 0.80)",
        "c-primary-dark-1000-alpha-300": "rgba(13, 50, 23, 0.70)",
        "c-primary-dark-1000-alpha-400": "rgba(13, 50, 23, 0.60)",
        "c-primary-dark-1000-alpha-500": "rgba(13, 50, 23, 0.50)",
        "c-primary-dark-1000-alpha-600": "rgba(13, 50, 23, 0.40)",
        "c-primary-dark-1000-alpha-700": "rgba(13, 50, 23, 0.30)",
        "c-primary-dark-1000-alpha-800": "rgba(13, 50, 23, 0.20)",
        "c-primary-dark-1000-alpha-900": "rgba(13, 50, 23, 0.10)",
        "c-primary-light-100": "rgb(79,163,103)",
        "c-primary-light-100-alpha-100": "rgba(79, 163, 103, 0.90)",
        "c-primary-light-100-alpha-200": "rgba(79, 163, 103, 0.80)",
        "c-primary-light-100-alpha-300": "rgba(79, 163, 103, 0.70)",
        "c-primary-light-100-alpha-400": "rgba(79, 163, 103, 0.60)",
        "c-primary-light-100-alpha-500": "rgba(79, 163, 103, 0.50)",
        "c-primary-light-100-alpha-600": "rgba(79, 163, 103, 0.40)",
        "c-primary-light-100-alpha-700": "rgba(79, 163, 103, 0.30)",
        "c-primary-light-100-alpha-800": "rgba(79, 163, 103, 0.20)",
        "c-primary-light-100-alpha-900": "rgba(79, 163, 103, 0.10)",
        "c-primary-light-200": "rgb(114,181,133)",
        "c-primary-light-200-alpha-100": "rgba(114, 181, 133, 0.90)",
        "c-primary-light-200-alpha-200": "rgba(114, 181, 133, 0.80)",
        "c-primary-light-200-alpha-300": "rgba(114, 181, 133, 0.70)",
        "c-primary-light-200-alpha-400": "rgba(114, 181, 133, 0.60)",
        "c-primary-light-200-alpha-500": "rgba(114, 181, 133, 0.50)",
        "c-primary-light-200-alpha-600": "rgba(114, 181, 133, 0.40)",
        "c-primary-light-200-alpha-700": "rgba(114, 181, 133, 0.30)",
        "c-primary-light-200-alpha-800": "rgba(114, 181, 133, 0.20)",
        "c-primary-light-200-alpha-900": "rgba(114, 181, 133, 0.10)",
        "c-primary-light-300": "rgb(142,196,157)",
        "c-primary-light-300-alpha-100": "rgba(142, 196, 157, 0.90)",
        "c-primary-light-300-alpha-200": "rgba(142, 196, 157, 0.80)",
        "c-primary-light-300-alpha-300": "rgba(142, 196, 157, 0.70)",
        "c-primary-light-300-alpha-400": "rgba(142, 196, 157, 0.60)",
        "c-primary-light-300-alpha-500": "rgba(142, 196, 157, 0.50)",
        "c-primary-light-300-alpha-600": "rgba(142, 196, 157, 0.40)",
        "c-primary-light-300-alpha-700": "rgba(142, 196, 157, 0.30)",
        "c-primary-light-300-alpha-800": "rgba(142, 196, 157, 0.20)",
        "c-primary-light-300-alpha-900": "rgba(142, 196, 157, 0.10)",
        "c-primary-light-400": "rgb(165,208,177)",
        "c-primary-light-400-alpha-100": "rgba(165, 208, 177, 0.90)",
        "c-primary-light-400-alpha-200": "rgba(165, 208, 177, 0.80)",
        "c-primary-light-400-alpha-300": "rgba(165, 208, 177, 0.70)",
        "c-primary-light-400-alpha-400": "rgba(165, 208, 177, 0.60)",
        "c-primary-light-400-alpha-500": "rgba(165, 208, 177, 0.50)",
        "c-primary-light-400-alpha-600": "rgba(165, 208, 177, 0.40)",
        "c-primary-light-400-alpha-700": "rgba(165, 208, 177, 0.30)",
        "c-primary-light-400-alpha-800": "rgba(165, 208, 177, 0.20)",
        "c-primary-light-400-alpha-900": "rgba(165, 208, 177, 0.10)",
        "c-primary-light-500": "rgb(183,217,193)",
        "c-primary-light-500-alpha-100": "rgba(183, 217, 193, 0.90)",
        "c-primary-light-500-alpha-200": "rgba(183, 217, 193, 0.80)",
        "c-primary-light-500-alpha-300": "rgba(183, 217, 193, 0.70)",
        "c-primary-light-500-alpha-400": "rgba(183, 217, 193, 0.60)",
        "c-primary-light-500-alpha-500": "rgba(183, 217, 193, 0.50)",
        "c-primary-light-500-alpha-600": "rgba(183, 217, 193, 0.40)",
        "c-primary-light-500-alpha-700": "rgba(183, 217, 193, 0.30)",
        "c-primary-light-500-alpha-800": "rgba(183, 217, 193, 0.20)",
        "c-primary-light-500-alpha-900": "rgba(183, 217, 193, 0.10)",
        "c-primary-light-600": "rgb(197,225,205)",
        "c-primary-light-600-alpha-100": "rgba(197, 225, 205, 0.90)",
        "c-primary-light-600-alpha-200": "rgba(197, 225, 205, 0.80)",
        "c-primary-light-600-alpha-300": "rgba(197, 225, 205, 0.70)",
        "c-primary-light-600-alpha-400": "rgba(197, 225, 205, 0.60)",
        "c-primary-light-600-alpha-500": "rgba(197, 225, 205, 0.50)",
        "c-primary-light-600-alpha-600": "rgba(197, 225, 205, 0.40)",
        "c-primary-light-600-alpha-700": "rgba(197, 225, 205, 0.30)",
        "c-primary-light-600-alpha-800": "rgba(197, 225, 205, 0.20)",
        "c-primary-light-600-alpha-900": "rgba(197, 225, 205, 0.10)",
        "c-primary-light-700": "rgb(209,231,215)",
        "c-primary-light-700-alpha-100": "rgba(209, 231, 215, 0.90)",
        "c-primary-light-700-alpha-200": "rgba(209, 231, 215, 0.80)",
        "c-primary-light-700-alpha-300": "rgba(209, 231, 215, 0.70)",
        "c-primary-light-700-alpha-400": "rgba(209, 231, 215, 0.60)",
        "c-primary-light-700-alpha-500": "rgba(209, 231, 215, 0.50)",
        "c-primary-light-700-alpha-600": "rgba(209, 231, 215, 0.40)",
        "c-primary-light-700-alpha-700": "rgba(209, 231, 215, 0.30)",
        "c-primary-light-700-alpha-800": "rgba(209, 231, 215, 0.20)",
        "c-primary-light-700-alpha-900": "rgba(209, 231, 215, 0.10)",
        "c-primary-light-800": "rgb(218,236,223)",
        "c-primary-light-800-alpha-100": "rgba(218, 236, 223, 0.90)",
        "c-primary-light-800-alpha-200": "rgba(218, 236, 223, 0.80)",
        "c-primary-light-800-alpha-300": "rgba(218, 236, 223, 0.70)",
        "c-primary-light-800-alpha-400": "rgba(218, 236, 223, 0.60)",
        "c-primary-light-800-alpha-500": "rgba(218, 236, 223, 0.50)",
        "c-primary-light-800-alpha-600": "rgba(218, 236, 223, 0.40)",
        "c-primary-light-800-alpha-700": "rgba(218, 236, 223, 0.30)",
        "c-primary-light-800-alpha-800": "rgba(218, 236, 223, 0.20)",
        "c-primary-light-800-alpha-900": "rgba(218, 236, 223, 0.10)",
        "c-primary-light-900": "rgb(225,240,229)",
        "c-primary-light-900-alpha-100": "rgba(225, 240, 229, 0.90)",
        "c-primary-light-900-alpha-200": "rgba(225, 240, 229, 0.80)",
        "c-primary-light-900-alpha-300": "rgba(225, 240, 229, 0.70)",
        "c-primary-light-900-alpha-400": "rgba(225, 240, 229, 0.60)",
        "c-primary-light-900-alpha-500": "rgba(225, 240, 229, 0.50)",
        "c-primary-light-900-alpha-600": "rgba(225, 240, 229, 0.40)",
        "c-primary-light-900-alpha-700": "rgba(225, 240, 229, 0.30)",
        "c-primary-light-900-alpha-800": "rgba(225, 240, 229, 0.20)",
        "c-primary-light-900-alpha-900": "rgba(225, 240, 229, 0.10)",
        "c-primary-light-1000": "rgb(255,255,255)",
        "c-primary-light-1000-alpha-100": "rgba(255, 255, 255, 0.90)",
        "c-primary-light-1000-alpha-200": "rgba(255, 255, 255, 0.80)",
        "c-primary-light-1000-alpha-300": "rgba(255, 255, 255, 0.70)",
      ...
      "extInfo": {
        "c-app-background": "rgba(0, 0, 0, 0)",
        "c-main-background": "rgba(235, 250, 240, 0.22)",
        ...
        "c-content-background": "rgba(230, 248, 235, 0.15)",
        "c-border-background": "rgba(80, 180, 100, 0.40)"
      }
    }
  }
] as const